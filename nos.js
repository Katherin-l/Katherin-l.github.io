 ...
 function establecerIdioma(idioma) {
     ...
     switch (idioma) {
         case 'usa':
            estaticc.textContent = 'Us';
            titlee.textContent = 'Who we are?';
            des.textContent = 'We are an agricultural coffee cooperative (CAC) that promotes the development of inclusive businesses through direct exports from more than 300 small coffee producers in the Amazon Region of Peru. We add value through the use of international certifications that guarantee our social responsibility and harmonious coexistence with the environment.';
            mis.textContent = 'MISSION';
            ...
            localisar4.textContent = 'Grande';
            localisar5.textContent = '(Uctubamba Amazonas - Perú)';
        ...
        case 'latino':
            estaticc.textContent = 'Nosotros'
            titlee.textContent = '¿Quiénes somos?';
            des.textContent = 'Somos una cooperativa agraria cafetalera que promueve el desarrollo de negocios inclusivos mediante la exportación directa de más de 300 pequeños productores cafetaleros de la región Amazonas - Perú. Siendo nuestro principal valor agregado las certificaciones internacionales que garantiza nuestra responsabilidad social y convivencia armoniosa con el medio ambiente.';
            mis.textContent = 'MISIÓN';
            vis.textContent = 'VISIÓN';
            ...
            localisar4.textContent = 'Grande';
            localisar5.textContent = '(Uctubamba Amazonas - Perú)';
            localisar6.textContent = 'Planta de procesos';
            localisar7.textContent = 'Jr. Isidro Mamani Nº 120';
            localisar8.textContent = 'Sector San Luis Bagua Grande',
            localisar9.textContent = 'Uctubamba Amazonas - Perú)';
